...
| `test_Deploy__Admin__Service__to__main` | `admin-qa` | CI on push to `main` |
...
- `team/roles/devops/reviews/02/14/v0.3.0__response-to-daily-brief__14-feb.md`
- `team/roles/devops/reviews/02/14/v0.2.41__fix__lambda-env-vars-for-deploy.md`
