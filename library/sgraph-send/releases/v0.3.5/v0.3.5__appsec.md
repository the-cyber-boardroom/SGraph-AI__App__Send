...
A tabletop exercise for this scenario is documented in `team/roles/appsec/reviews/02/13/v0.2.24__tabletop-exercise__total-aws-compromise.md`.
...
- `team/roles/appsec/reviews/02/12/v0.2.15__threat-model__sgraph-send.md`
- `team/roles/appsec/reviews/02/13/v0.2.24__response-to-daily-brief__13-feb.md`
- `team/roles/appsec/reviews/02/13/v0.2.24__status-report__post-launch.md`
- `team/roles/appsec/reviews/02/14/v0.3.0__response-to-daily-brief__14-feb.md`
- `team/roles/appsec/reviews/02/14/v0.3.2__action-plan__explorer-next-steps.md`
- `team/roles/appsec/reviews/02/13/v0.2.24__tabletop-exercise__total-aws-compromise.md`
