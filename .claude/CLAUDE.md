...
| Explorer role definition | `team/humans/dinis_cruz/briefs/02/14/v0.3.2__role-definition__explorer.md` |
| Villager role definition | `team/humans/dinis_cruz/briefs/02/14/v0.3.2__role-definition__villager.md` |
| Latest debrief | `team/humans/dinis_cruz/debriefs/03/23/v0.16.54__debrief__comms-structure-and-qa-change-requests.md` |
| Session handoff | `team/humans/dinis_cruz/debriefs/03/18/v0.16.26__session-handoff__explorer-librarian-brief-processing.md` |
| Master index (latest) | `team/roles/librarian/reviews/03/23/v0.16.55__master-index__briefs-22-to-23-march.md` |
| Master index (previous) | `team/roles/librarian/reviews/03/22/v0.16.42__master-index__briefs-19-to-22-march.md` |
