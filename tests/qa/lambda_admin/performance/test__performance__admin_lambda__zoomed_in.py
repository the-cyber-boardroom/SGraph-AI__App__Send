...
#
# FILE_NAME__ADMIN_LAMBDA__ENV = "perf-tests.env"
#
...
#     @classmethod
#     def setUpClass(cls):
#         path_dotenv = path_combine(__file__, f'../{FILE_NAME__ADMIN_LAMBDA__ENV}')
#         if file_not_exists(path_dotenv):
#             skip_pytest("Tests need .env file")
#         load_dotenv(path_dotenv, override=True)
#         # if not get_env('AWS_ACCOUNT_ID'):
#         #     skip_pytest("Could not find aws auth")
#
#         super().setUpClass()
