...
class test__App_Send__UI__User__static_pages(TestCase):
    ...
    def test__send(self):
        ...
        assert response__no_redirects.headers['location'] == '/send/v0/v0.1/v0.1.4/index.html'      # remove once we have more versions, but good to see what the path looks like
