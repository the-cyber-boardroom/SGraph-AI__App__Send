...
**Previous architecture:** `team/roles/architect/reviews/02/15/v0.3.6__implementation-proposal__observability-pipeline.md`
...
| Observability pipeline proposal | `team/roles/architect/reviews/02/15/v0.3.6__implementation-proposal__observability-pipeline.md` |
