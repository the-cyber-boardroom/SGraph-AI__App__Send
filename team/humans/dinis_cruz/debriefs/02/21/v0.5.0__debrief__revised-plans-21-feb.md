...
- **[AppSec Read Now](../../../../../roles/appsec/reviews/02/21/v0.5.0__appsec__read-now.md)** — 3 things to address in the build (case-insensitive normalisation, rate limiting, transparency log Phase 1). 5 things already handled by admin auth. 2 things to note (no challenge-response yet, findings only real when endpoints hit User Lambda).

### 2. Revised Dev plan (5 min)

- **[Dev Implementation Plan (Revised)](../../../../../roles/dev/reviews/02/21/v0.5.0__implementation-plan__key-discovery-and-registry-revised.md)** — Complete rewrite using IFD Issues-FS architecture. 5 phases: (1) IFD foundation + debug panels, (2) PKI component refactor, (3) Backend API + key discovery components, (4) Storage browser, (5) QR + polish. Full component inventory, event catalogue, shell layout diagram.

### 3. GRC risk (1 min)

- **[GRC Risk: Auth Model Transition](../../../../../roles/appsec/reviews/02/21/v0.5.0__grc-risk__auth-model-transition.md)** — Tracks the risk of moving from the current high-trust model to a wider user base. Lists 5 triggers that mandate a full AppSec review before proceeding.

### 4. Future findings (reference)

- **[AppSec Future Findings](../../../../../roles/appsec/reviews/02/21/v0.5.0__appsec__future-findings-catalogue.md)** — 13 deferred findings for Chain of Trust and Secure Pod, with "revisit when" triggers. Read when those features move to implementation.
...
| # | Document | Role |
|---|----------|------|
| 1 | [AppSec: Read Now](../../../../../roles/appsec/reviews/02/21/v0.5.0__appsec__read-now.md) | AppSec |
| 2 | [AppSec: Future Findings](../../../../../roles/appsec/reviews/02/21/v0.5.0__appsec__future-findings-catalogue.md) | AppSec |
| 3 | [AppSec: Revised Review](../../../../../roles/appsec/reviews/02/21/v0.5.0__review__pki-architecture-security-revised.md) | AppSec |
| 4 | [GRC Risk: Auth Transition](../../../../../roles/appsec/reviews/02/21/v0.5.0__grc-risk__auth-model-transition.md) | GRC |
| 5 | [Dev Plan: Revised](../../../../../roles/dev/reviews/02/21/v0.5.0__implementation-plan__key-discovery-and-registry-revised.md) | Dev |
| 6 | [Librarian Catalogue](../../../../../roles/librarian/reviews/02/21/v0.5.0__catalogue__revised-reviews-21-feb.md) | Librarian |
