...
**Domain:** qa/ | **Last updated:** 2026-08-05 | **Maintained by:** Librarian (daily run)
...
**Total ~2950+** = 977 Python + ~157 vault-UI JS (sub-vaults/public-previews/app-perms/VaultSubvaultsView) + ~930+ ViV loader suite (373+ base + ~400 new from LLM/voice/releases/send-browse-split sessions 08/02–08/03; +~150 new from vision/auto-pull-fix session 08/05; see table below) + ~78 app-shell JS + 37 embed-protocol + ~334 inbox/write-batch/owner-secrets suite + browser integration: 8 tests + 10 app-shell-nav-helpers inbox/folder-app.json tests.
