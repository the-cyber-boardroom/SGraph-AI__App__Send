# Identity — Proposed: Credits, Billing, and Commercial Model
...
Source documents: archived monolith `../v0.16.26__what-exists-today.md` sections 6, 16, 20, 23;
05/14 brief (doc 396); 05/17 brief (doc 397); 05/15 brief (doc 415). See index.md for full P-number inventory.
