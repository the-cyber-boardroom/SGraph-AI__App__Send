...
| Open PROPOSED items (across all domains) | ~1116+ (+30 from 09/18 run + 09/20 confirmation: P-CEDAR-001/P-CED-001, P-GMPK-001, P-INS-001–004, P-PRIM-001, P-GAME-EXC-001/P-EXC-001, P-GAME-CAP-001/P-CAP-001, P-LTV-001–002/P-LTO-001, P-OBS-STATUS-001/P-SBL-001, P-CONF-001–003, P-REPO-001/P-GGA-001, P-ASSESS-001–002/P-APR-001, P-GAME-GUESS-001, P-GAME-REACH-001/P-GMS-001, P-GAME-CAL-001, P-GAME-ARC-001, P-CRED-001/P-PLT-001+P-CSY-001, P-VTV-001, P-LOG-001/P-ALA-001, P-RETURN-001/P-RPL-001, P-GAME-PRIM-001/P-PRM-001, P-PROVIDER-001/P-PRV-001, P-PLAYGROUND-001/P-PLG-001, P-VIDEO-001/P-VID-001; prev: ~1086+ from 09/08) |
| Total documents catalogued | **1,023** (+43 from 26 Aug–7 Sep; docs 981–1023; processed across 09/09–09/20 runs; prev: 980)
...
| **Key decision** | **Adopt Cedar policy language** — composable with identity registry; Cedar covers permissions, the registry covers identity; Cedar does not establish identity (its own documentation states this); the mandate has no standard; Cedar covers the permissions file; grant is measured rather than authored (grant/mandate brief, 2026-08-26) |
...
| **Key decision** | **Adopt probe and finding vocabulary** — the vocabulary proposed for the public repository already exists in a widely-adopted project with definitions close enough to adopt; the same project replaced a score with structured findings for precisely the reason this corpus objected to collapsed maturity levels; grants are public, mandates never leave the clone (research brief, 2026-09-04) |
| **Key decision** | **Five renderings of one measurement** — adopt OSCAL and SARIF as interchange standards rather than minting a third schema; five renderings of one measurement rather than five measurements; import matters as much as export; mandate authoring step has no tool and cannot have one (assessment product, 2026-09-05) |
...
| **Key decision** | **Read documentation for the product, not the vendor** — provider credential rules differ by product; 5 Sep brief quoted agent product's signed-URL rule on a speech page; speech endpoint does not accept signed URLs; the 4 Sep lesson (clone the thing) in a new form (correction, 2026-09-07) |
