...
**Version:** v0.31.18 | **Last updated:** 2026-06-02 | **Maintained by:** Librarian (daily run)
...
| Unit tests passing | **~1257+** (~602 Python + ~157 vault-UI JS from sub-vaults/public-previews/app-perms/VaultSubvaultsView + ~364 ViV loader suite from Phase 1–5.1 inc. B4–B10/KernelParent/AppFrameBootstrap/VivAuditView/SgReplCore + ~78 app-shell extraction AppHudConfig:31+AppNavHelpers:47 + 5 new Python browser integration tests) |
...
| Open PROPOSED items (across all domains) | 416+ (397+ previous + 19 new P-281–P-299 from 05/30–06/01 briefs) |
| Total documents catalogued | 546 (+ 22 new human briefs from 05/30, 05/31, 06/01 processed 06/02) |
