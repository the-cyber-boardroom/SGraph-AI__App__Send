...
**Version:** v0.33.37 | **Last updated:** 2026-07-01 | **Maintained by:** Librarian (daily run)
...
| Unit tests passing | **~2015+** (977 Python + ~167 vault-UI JS + ~373 ViV loader suite + ~78 app-shell extraction + 37 embed-protocol + ~334 inbox/write-batch/owner-secrets suite; browser integration: 8 tests; +10 from app-shell-nav-helpers inbox/folder-app.json) |
