...
**Version:** v0.28.7 | **Last updated:** 2026-05-27 | **Maintained by:** Librarian (daily run)
...
| Unit tests passing | **~760+** (~602 Python + ~150 new vault-UI JS assertions from sub-vaults, public previews, app-perms) |
...
| Open PROPOSED items (across all domains) | 366+ (365+ + 1 added 05/27 for P-248 Talk to the vault) |
| Total documents catalogued | 493 (488 + 5 briefs processed 05/25; SG/Send vault product thread Day 71) |
