...
**Version:** v0.33.43 | **Last updated:** 2026-07-24 | **Maintained by:** Librarian (daily run)
...
| Open PROPOSED items (across all domains) | ~819+ (+39 net-new from 5 July: AWS-engine 14, agent-risk-thesis 9, experience-loop 7, evidence-economy 9; previously ~780+) |
| Total documents catalogued | 820 (+10 from 5 July: 9 substantive briefs + 1 day-index, processed 2026-07-24) |
