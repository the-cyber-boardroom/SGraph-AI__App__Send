...
| **Declared mounts** (top kernel registers `.link.json` mounts via `KernelParent.mount()` at boot; app never calls `mount`) | **PROPOSED** | `team/roles/architect/reviews/09/07/v0.33.64__architect-analysis__declared-mounts…` |
