...
| 2026-08-07 | No new briefs; 4 functional commits (22061eb, cf5b76e, 2d651b4, 2512c1c); v0.33.53 | 3 new EXISTS items: SGVision (screenshot paste, live catalogue check), sync-safety fix (auto-apply → click-to-apply), PREFERRED_MODELS (claude-sonnet-5 default). Test count ~2800+ → ~2950+ (ViV suite ~780+ → ~930+). 4 reality files updated; master index + debrief produced |
