...
|------|----------|---------|
| **Architect** | [`v0.4.25__briefing__pki-messaging-architecture.md`](../../architect/reviews/02/20/v0.4.25__briefing__pki-messaging-architecture.md) | Full technical briefing with ASCII art workflows, data model, payload format, security properties |
| **Historian** | [`v0.4.25__milestone__first-pki-message-exchange.md`](../../historian/reviews/02/20/v0.4.25__milestone__first-pki-message-exchange.md) | Timeline, decision log, significance in project history |
| **Journalist** | [`v0.4.25__article__pki-milestone.md`](../../journalist/reviews/02/20/v0.4.25__article__pki-milestone.md) | Narrative article capturing the milestone moment |
...
| **QA** | [`v0.4.25__verification__pki-end-to-end.md`](../../qa/reviews/02/20/v0.4.25__verification__pki-end-to-end.md) | Verification report — what was tested and confirmed |
...
| Original architect plan | [`v0.4.17__implementation-plan__browser-pki-key-management.md`](../../architect/reviews/02/20/v0.4.17__implementation-plan__browser-pki-key-management.md) |
