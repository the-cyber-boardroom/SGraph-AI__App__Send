...
- `team/roles/architect/reviews/02/15/v0.3.6__implementation-proposal__observability-pipeline.md`
- `team/roles/architect/reviews/02/14/v0.3.2__action-plan__explorer-next-steps.md`
...
**Location for all deliverables:** `team/roles/architect/reviews/02/15/`
