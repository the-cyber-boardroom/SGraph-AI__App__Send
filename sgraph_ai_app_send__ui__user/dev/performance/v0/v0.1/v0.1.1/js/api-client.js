// SGraph Send — Performance Tool — API Client  (v0.1.1 patch)
// Change: vaultDestroy now accepts { purge } option. purge=true tells the
// backend to skip writing deleted.json, leaving the vault_id fully reusable
// and producing no S3 residue. All other methods unchanged from v0.1.0.
