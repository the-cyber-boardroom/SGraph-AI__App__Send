// SGraph Send — Performance Tool — Artifact Tracker
// Records every transfer and vault the tool creates in localStorage so we can
// (a) clean up orphans if a run crashes, and (b) provide a real fixture list
// for testing the read paths.
