...
var SgPrint = (function() {
    ...
    var PRINT_STYLES = [
        ...
        '    /* md-pb-marker: generated by MarkdownParser for page_break_before / <!-- page-break --> */',
        '    /* Inline styles already apply the dashed-rule look; this just hides the label on screen */',
        '    .md-pb-marker { display: flex !important; }',
        '    /* md-frontmatter: doc-settings badge — visible on screen, hidden in print */',
        ...
        '    .md-pb-marker { display: block !important; height: 0 !important; margin: 0 !important; padding: 0 !important; border: none !important; overflow: hidden !important; page-break-after: always; break-after: page; }',
        '    .md-pb-marker__label { display: none !important; }',
        '    /* md-frontmatter: hidden in print — doc-settings badge is screen-only */',
        '    .md-frontmatter { display: none !important; }',
        '}',
        '',
