...
(function() {
    ...
    VaultHeader.styles = `
        ...
        .vh-vault-name { font-size: var(--text-h3); font-weight: 700; color: var(--color-text); font-family: var(--font-mono); cursor: pointer; border-radius: 3px; padding: 1px 3px; max-width: 40ch; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        ...
        .vh-vault-name-input {
            ...
            border-radius: 3px; padding: 1px 4px; outline: none; min-width: 200px;
        }
