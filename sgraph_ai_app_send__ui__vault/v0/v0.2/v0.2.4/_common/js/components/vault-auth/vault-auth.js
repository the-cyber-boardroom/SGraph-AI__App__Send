...
(function() {
    ...
    VaultAuth.styles = `
        ...
        /* Phone-first: the message row, then a full-width input + buttons row.
           The nowrap message + 320px input + buttons overflow at 390px otherwise. */
        @media (max-width: 600px) {
            .va-banner { flex-wrap: wrap; padding: 0.375rem var(--space-2); }
            .va-msg { white-space: normal; flex-basis: 100%; }
            .va-input { max-width: none; min-height: var(--touch-target, 44px); }
            .va-submit, .va-cancel { min-height: var(--touch-target, 44px); }
        }
    `;
