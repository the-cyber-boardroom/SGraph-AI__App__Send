...
(function() {
    ...
    VaultSettings.styles = `
        ...
        /* Phone-first: full-width panel, stacked key row, 44px touch targets. */
        @media (max-width: 600px) {
            .vset-panel { max-width: 100%; padding: var(--space-3); }
            .vset-row { flex-direction: column; }
            .vset-row input { width: 100%; }
            .vset-input, .vset-btn { min-height: var(--touch-target, 44px); }
        }
    `;
