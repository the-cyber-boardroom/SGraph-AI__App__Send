...
(function() {
    ...
    VaultStatusBar.styles = `
        ...
        /* Phone-first: tighten the footer gap so stats + peek + badge fit at 390px. */
        @media (max-width: 600px) {
            .vsb-bar { gap: var(--space-2); padding: 0.25rem var(--space-2); }
            .vsb-stats { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
        }
    `;
